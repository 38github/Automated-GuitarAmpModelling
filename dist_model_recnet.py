...
prsr.add_argument('--num_blocks', '-nb', default=2, type=int, help='Number of recurrent or convolutional blocks') # 2
prsr.add_argument('--num_layers', '-nl', default=2, type=int, help='Number of layers in each conv block') # 2
