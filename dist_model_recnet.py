...
prsr.add_argument('--num_blocks', '-nb', default=3, type=int, help='Number of recurrent or convolutional blocks') # 2
prsr.add_argument('--num_layers', '-nl', default=3, type=int, help='Number of layers in each conv block') # 2
prsr.add_argument('--hidden_size', '-hs', default=8, type=int, help='Rec unit hidden state size, or conv channels')
prsr.add_argument('--kernel_size', '-ks', default=4, type=int, help='kernel size in conv layers') # 3
